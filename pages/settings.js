    ...
    <>
      ...
      <Layout>
        ...
        <div className="main-panel">
          ...
          <div className="mb-10">
            <div className="profileSettings" id={styles.profileSettings}>
              <p className="profileSettingsText">Personal Details</p>
            </div>
          </div>
          <div className="w-[75%] md:flex align-center justify-center md:justify-between relative md:left-[285px] left-[45px]">
            <form className="mt-4">
          ...
          <div className="mb-10">
            ...
            <div className="w-[75%] md:flex align-center justify-center md:justify-between relative md:left-[285px] left-[45px] top-12 my-auto">
              <form className="mt-4">
                <div className="md:flex md:items-center mb-6">
                  <label
