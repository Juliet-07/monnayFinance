      ...
      >
        <div className={styles.jumbotronFluidReg}>
          ...
          <div className={styles.termsBody}>
            ...
            <ul className={styles.termsList}>
              <li style={{ margin: "15px" }}>
                Terms {`&`} Conditions of Service as set forth herein shall
                govern the relationship between the Participant and the Fund and
                are effective immediately after the Participant has made a
                deposit with the online investment program provided by the Fund
                and shall be valid till the deposit term expires.
              </li>
              <li style={{ margin: "15px" }}>
              ...
              <li style={{ margin: "15px" }}>
                The Firm does not offer advices on the suitability of the{" "}
                {`Firm's`}
                services for the {`Participant's`} individual needs, nor does
                the Firm provides for any judgment on the {`Participant's`}{" "}
                behalf, relating to government or tax regulations in particular.
                It is the responsibility of the Investor to take independent
                assessment as to the suitability of said investment scheme for
                the {`Participant's`} particular circumstances. No information
                on the {`Firm's`} website is to be considered as a solicitation
                or an offer to participate in investment schemes the Firm
                provides.
              </li>
              <li style={{ margin: "15px" }}>
            ...
            <ul className={styles.termsList}>
              ...
              <li style={{ margin: "15px" }}>
                ...
                to the {`Participant's`} account balance at the date of
                maturity, and is available for disposal anytime thereafter.
              </li>
              <li style={{ margin: "15px" }}>
                The funds available at the {`Participant's`} account balance
                bear no interest and are available for withdrawal, or can be
                reinvested again at the {`Participant's`} discretion.
              </li>
            </ul>
            ...
            <ul className={styles.termsList}>
              <li style={{ margin: "15px" }}>
                ...
                Sunday directly to the {`Participant's`} e-currency account
                within 24 hours after withdrawal request has been submitted.
            ...
            <ul className={styles.termsList}>
              ...
              <li style={{ margin: "15px" }}>
                ...
                access to {`Participant's`} account. It is {`Participant's`}{" "}
                sole responsibility to check his system for trojans, key loggers
                and other malware.
              </li>
              <li style={{ margin: "15px" }}>
                The Participant agrees to hold the Firm harmless of any
                liability regarding possible loss of {`Participant's`} funds
                during investment process. Participant understands that every
          ...
          <p className={styles.agreeTerms}>
            ...
            bound by the Terms and Conditions above. If you {`don't`} agree,
